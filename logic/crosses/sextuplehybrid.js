...
const sextuplehybrid = (fatherGenotype, motherGenotype, payload) => {
                ...
                for (let p = 0; p < motherGenotype[3].length; p++) {
                  for (let q = 0; q < fatherGenotype[4].length; q++) {
                    for (let r = 0; r < motherGenotype[4].length; r++) {
                      for (let s = 0; s < fatherGenotype[4].length; s++) {
                        for (let t = 0; t < motherGenotype[4].length; t++) {
                          const genotype =
                            ...
                            [fatherGenotype[4][q], motherGenotype[4][r]]
                              .sort()
                              .join('') +
                            [fatherGenotype[5][s], motherGenotype[5][t]]
                              .sort()
                              .join('')
                          ...
                          payload.punnettSquare[
                            32 * j + 16 * l + 8 * n + 4 * p + 2 * r + t
                          ][32 * i + 16 * k + 8 * m + 4 * o + 2 * q + s] = {
                            genotype,
                            phenotype,
                          }
